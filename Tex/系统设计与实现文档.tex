...
% 原占位图（保留以备参考）:
\includegraphics[width=6.2in,height=4.5in]{media/2.5/uml1.jpg} % Placeholder for Venue Event Class Diagram
...
\includegraphics[width=6.2in,height=4.5in]{media/2.5/uml2.jpg} % Placeholder for Sale Event Class Diagram
...
\includegraphics[width=6.2in,height=4.5in]{media/2.7/uml.jpg} % Placeholder for Merchant Module Class Diagram
...
\includegraphics[width=6.2in,height=4.5in]{media/2.8/uml.jpg} % Placeholder for Parking Module Class Diagram
